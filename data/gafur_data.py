# G'afur G'ulom haqida asosiy ma'lumotlar

BIOGRAPHY = """
👤 *G'AFUR G'ULOM — O'ZBEK ADABIYOTINING ULUG' SIYMOSI*
...
G'afur G'ulom o'zbek she'riyatining eng yorqin siymolaridan biri. Uning she'rlari samimiylik, vatanparvarlik va insoniy tuyg'ular bilan sug'orilgan.

*Mashhur she'rlaridan:*
...
STORIES_INFO = """
📝 *G'AFUR G'ULOMNING HIKOYALARI*

G'afur G'ulom nasrda ham ajoyib asarlar yaratgan. Uning hikoyalari hayotiy, ta'sirchan va chuqur mazmunli.
...
═══════════════════════════════════════
G'AFUR G'ULOM — TO'LIQ BIOGRAFIYA
═══════════════════════════════════════
...
G'afur G'ulom ijodining o'ziga xos xususiyatlari:
1. HAZIL VA KINOYA — asarlarida yumshoq hazil, o'tkir kinoya uyg'un keladi
2. XALQCHILLIK — oddiy xalq tili, maqol va iboralar ko'p ishlatiladi
3. AVTOBIOGRAFIZM — o'z hayotidan olingan voqealar asosida yozgan
4. VATANPARVARLIK — Vatan, xalq, ona yer sevgisi barcha asarlarida seziladi
5. INSONPARVARLIK — oddiy insonlarga muhabbat, ularga hurmat
6. LIRIZM — his-tuyg'ularni chuqur ifodalash qobiliyati

TARJIMALARI:
G'afur G'ulom jahon adabiyoti namunalarini o'zbek tiliga tarjima qilgan:
• Pushkin asarlari
• Lermontov she'rlari  
• Shekspir asarlari
• Gyote asarlari
...
G'afur G'ulom XX asr o'zbek adabiyotining eng yirik namoyandalaridan biri. U:
- O'zbek nasrini yangi bosqichga ko'tardi
- She'riyatda yangi uslub yaratdi
- Bolalar adabiyotiga katta hissa qo'shdi
- O'zbek adabiyotini jahon adabiyoti bilan bog'ladi
- Hamza Hakimzoda Niyoziy, Oybek, Abdulla Qahhor bilan bir davrda yashab ijod qildi

═══════════════════════════════════════
QOIDALAR — BULAR JUDA MUHIM
═══════════════════════════════════════

1. FAQAT O'ZBEK TILIDA javob bering — hech qachon rus, ingliz yoki boshqa tilda yozmang
2. Yuqoridagi ma'lumotlarga tayanib javob bering
3. Bilmagan narsangizni to'qib chiqarmang — "Bu haqda aniq ma'lumotim yo'q" deng
4. Foydalanuvchiga samimiy va do'stona munosabatda bo'ling
5. Javoblar 200-600 so'z orasida bo'lsin
6. She'r so'ralganda — yuqoridagi she'r parchalarini ishlating
7. Tahlil so'ralganda — chuqur va mazmunli javob bering"""
